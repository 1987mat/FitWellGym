...
<main class="main-body-content">
  ...
  <section class="history-section">
    ...
    <div class="our-history" data-observe>
      ...
      ?>
      <img src="<?php echo $img_src ?>" width="480" height="480" alt="history">
    ...
    <div class="classes-container" data-observe>
      <?php 
          ...
          while($homepageClasses->have_posts()) {
            ...
            <a class="single-class <?php echo $classTitle; ?>" href="<?php echo get_post_type_archive_link('class'); ?>" aria-label="class">              
            <h3><?php the_title(); ?></h3> 
            </a>
  ...
  <section class="homepage-workouts" id="workout-programs">
    ...
    <div class="workout-heading" data-observe>  
      <a href="<?php echo get_post_type_archive_link('workout'); ?>" aria-label="workouts">View More</a>
    </div>
  </section>

  <section class="homepage-events"> 
    <div class="events-heading" data-observe>
      <a href="<?php echo get_post_type_archive_link('event'); ?>" aria-label="events">Events & More</a>
    </div>
  </section>
  ...
  <section class="homepage-feeds"> 
    ...
    <div class="social-media-container" data-observe>
      ...
      <a href="https://pinterest.com" target="_blank" aria-label="pinterest"><i class="fa fa-pinterest"></i></a>
    </div>
